...
# Думаю, что в данном случае оператор распаковки будет бесполезным,
# т.к. работаю со списком, а не строкой.
# Но вообще оператор распаковки может быть очень полезным,
# особенно при работе с неизвестным кол-вом аргументов.